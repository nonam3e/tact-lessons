...
function initSaleNft_init_args(src: SaleNft_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeAddress(src.owner);
        b_0.storeAddress(src.nft);
...
async function SaleNft_init(owner: Address, nft: Address, price: bigint, jetton_master: Address, numerator: bigint, denominator: bigint, royalty_destination: Address | null) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initSaleNft_init_args({ $$type: 'SaleNft_init_args', owner, nft, price, jetton_master, numerator, denominator, royalty_destination })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const SaleNft_errors: { [key: number]: { message: string } } = {
...
export class SaleNft implements Contract {
    ...
    static async init(owner: Address, nft: Address, price: bigint, jetton_master: Address, numerator: bigint, denominator: bigint, royalty_destination: Address | null) {
        return await SaleNft_init(owner, nft, price, jetton_master, numerator, denominator, royalty_destination);
    }
    ...
    static async fromInit(owner: Address, nft: Address, price: bigint, jetton_master: Address, numerator: bigint, denominator: bigint, royalty_destination: Address | null) {
        const init = await SaleNft_init(owner, nft, price, jetton_master, numerator, denominator, royalty_destination);
        const address = contractAddress(0, init);
        return new SaleNft(address, init);
    }
    
    static fromAddress(address: Address) {
        return new SaleNft(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        errors: SaleNft_errors
    };
